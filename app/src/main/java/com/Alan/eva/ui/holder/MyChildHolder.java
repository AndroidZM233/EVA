...
public class MyChildHolder extends AbsViewHolder {
    ...
    public void bindData(ChildModel model) {
        ...
        tv_item_my_child_age.setText(String.format("%s岁", age));
        tv_item_my_child_height.setText(String.format("%scm", height));
        tv_item_my_child_weight.setText(String.format("%skg", weight));
        Tools.display(circle_child_portrait, portrait);
        if (isOwner) {
